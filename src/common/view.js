...
YSLOW.view.prototype = {
    ...
    setSplashView: function (hideAutoRun, showAntiIframe, hideToolsInfo /*TODO: remove once tools are working*/) {
        ...
        sHtml += '<div id="runtestDiv"><button id="runtest-btn" onclick="javascript:document.ysview.runTest()">Run Test</button></div></div><div class="footer"><div class="moreinfo">' + '<a href="javascript:document.ysview.openLink(\'https://developer.yahoo.com/yslow/\');"><b>&#187;</b>' + more_info_text + '</a></div></div></div></div></div>';
