...
- {property: og:title, content: YSlow Scoremeter Grade A}
- {property: og:type, content: website}
- {property: og:image, content: http://imgur.com/ugYmK.png}
...
- {name: twitter:title, content: YSlow Scoremeter Grade A}
- {name: twitter:image, content: http://imgur.com/ugYmK.png}
levelup: true
---
